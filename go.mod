...
replace github.com/go-chi/jwtauth/v5 => github.com/alexlovelltroy/jwtauth/v5 v5.3.1-20240826
...
require (
	github.com/OpenCHAMI/jwtauth/v5 v5.0.0-20240321222802-e6cb468a2a18 // indirect
